    ...
    <footer className="bg-gray-900 text-white pt-16 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          {/* Unternehmensinfo */}
          <div>
            <h3 className="text-xl font-bold mb-4">Ct Studio</h3>
            <p className="text-gray-400 mb-4">
              Wir erstellen beeindruckende Websites mit modernen Technologien, kreativen Designs und SEO-Optimierung.
            </p>
            <div className="flex space-x-4 mt-4">
              <a 
                href="https://www.instagram.com/ch1scl?igsh=MWExOGMyaXF0c3ExOA%3D%3D&utm_source=qr" 
                target="_blank" 
          ...
          <div>
            ...
            <address className="not-italic text-gray-400">
              ...
              <p>
                <a href="tel:+4915167270985" className="hover:text-white transition-colors">
                  +49 15167270985
                </a>
              </p>
            </address>
        ...
        <div className="text-center pt-8 border-t border-gray-800 text-gray-500 text-sm">
          <p>© {new Date().getFullYear()} Ct Studio. Alle Rechte vorbehalten.</p>
